...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
            ...
            "**Heroku Connecting To Latest Github Build (TheShashankk/COFFIN X)**",
            ...
            "__INFO:COFFIN X:Logged in as 557667062__",
            "__INFO:COFFIN X:Successfully loaded all plugins__",
            "**Build Succeeded**"
